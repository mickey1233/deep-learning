...
#UPLOAD_FOLDER = r"d:\work\python\test_flask\training_data"
UPLOAD_FOLDER = os.path.join(folder_path,'training_data')
DOWN_FOLDER = os.path.join(folder_path,'training_data')
app = Flask(__name__)
